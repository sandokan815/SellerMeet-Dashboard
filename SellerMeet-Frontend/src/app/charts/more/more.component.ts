...
@Component({
  selector: 'my-chart-more',
  styles: [],
  templateUrl: './more.component.html'
})

export class ChartMoreComponent {
  config = CHARTCONFIG;
